jQuery(function ($) {
    ...
    $(document).on('click', '.update-product-button', function () {
        ...
        $.getJSON("api/product/read_one.php?id=" + id, function (data) {
            // значение будут использоватся для заполнения нашей формы
            var name = data.name;
            ...
            <form id='update-product-form' action='#' method='post' border='0'>
                <table class='table table-hover table-responsive table-bordered'>
                    ...
                    <tr>
                        <td>Описание</td>
                        <td><textarea style='resize: none' name='description' class='form-control' required>` + description + `</textarea> </td>
                    </tr>
                    <tr>
                        <td>Категория</td>
